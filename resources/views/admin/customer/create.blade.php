            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- form start -->
                        <form action="{{ route('p-admin-customer') }}" method="post">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Nhập số điện thoại" name="phone"/>
                                    @if ($errors->has('phone'))
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Địa chỉ" name="address" />
