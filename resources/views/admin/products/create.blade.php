            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- form start -->
                        <form action="{{ route('p-admin-product') }}" method="post" enctype="multipart/form-data">
                        	<input type="hidden" name="_token" value="{{ csrf_token() }}" />
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="name">Tên sản phẩm</label>
                                    <input type="text" name="name" class="form-control" id="name" placeholder="Nhập tên sản phẩm" />
                                    @if ($errors->has('name'))
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="" placeholder="Giá niêm yết" name="cost_sale" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="" placeholder="Giá bán" name="cost_price"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="" placeholder="Giá bán" name="unit" />
                                    @if ($errors->has('unit'))
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="" placeholder="Tiêu đề" name="title"/>
                                    @if ($errors->has('title'))
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" cols="20" rows="5" name="description" placeholder="Nhập mô tả"></textarea>
